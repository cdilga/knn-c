...
//
my_string file_read_string(const char* prompt);

//
// Reads a integer from the user.
//
int file_read_integer(const char* prompt);

//
// Reads a integer from the user in a given range.
//
int file_read_integer_range(const char* prompt, int min, int max);

//
// Reads a double from the user.
//
double file_read_double(const char* prompt);
